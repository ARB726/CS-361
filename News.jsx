...
const News = () => {
  return (
    <div className='py-16 max-w-6xl mx-auto'>
        ...
        <Swiper
            slidesPerView={2}  // Always show 2 news items per slide
            spaceBetween={30}
            navigation={true}
        ...
        >
            {news.map((item, index) => (
                <SwiperSlide key={index}>
                    <div className="flex flex-col md:flex-row items-start gap-6 p-4 border rounded-lg shadow-md bg-white">
                        {/* Left Content */}
                        <div className="flex-1">
                            <Link to="/">
                                <h3 className="text-lg font-semibold hover:text-blue-500 mb-2">{item.title}</h3>
                            </Link>
                        ...
                        <div className="flex-shrink-0 w-32 md:w-48">
                            <img src={item.image} alt="news" className="w-full h-auto object-cover rounded-md shadow-sm" />
                        </div>
                    </div>
                </SwiperSlide>
            ))}
